package com.example.eichwalde_app
 ...
 */
class EichwaldeAppHomeWidget : AppWidgetProvider() {
...
internal fun updateAppWidget(
    ...
    val views = RemoteViews(context.packageName, R.layout.eichwalde__app__home_widget)
